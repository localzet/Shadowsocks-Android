...
import com.localzet.shadowsocks.plugin.fragment.showAllowingStateLoss
import com.localzet.shadowsocks.preference.DataStore
import com.localzet.shadowsocks.utils.Action
import com.localzet.shadowsocks.utils.OpenJson
import com.localzet.shadowsocks.utils.SaveJson
...
class ProfilesFragment : ToolbarFragment(), Toolbar.OnMenuItemClickListener, SearchView.OnQueryTextListener {
    companion object {
        ...
        private const val KEY_URL = "com.localzet.shadowsocks.QRCodeDialog.KEY_URL"
