...
import com.localzet.shadowsocks.bg.ProxyService
import com.localzet.shadowsocks.bg.TransproxyService
import com.localzet.shadowsocks.bg.VpnService
...
class ShadowsocksConnection(private var listenForDeath: Boolean = false) : ServiceConnection, IBinder.DeathRecipient {
    ...
    interface Callback {
        ...
        fun onServiceConnected(service: com.localzet.shadowsocks.aidl.IShadowsocksService)
        /**
    ...
    private val serviceCallback = object : com.localzet.shadowsocks.aidl.IShadowsocksServiceCallback.Stub() {
    ...
    var service: com.localzet.shadowsocks.aidl.IShadowsocksService? = null

    override fun onServiceConnected(name: ComponentName?, binder: IBinder) {
        this.binder = binder
        val service = com.localzet.shadowsocks.aidl.IShadowsocksService.Stub.asInterface(binder)!!
