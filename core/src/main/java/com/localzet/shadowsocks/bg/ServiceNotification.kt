...
class ServiceNotification(private val service: BaseService.Interface, profileName: String,
    ...
    private val callback: com.localzet.shadowsocks.aidl.IShadowsocksServiceCallback by lazy {
        object : com.localzet.shadowsocks.aidl.IShadowsocksServiceCallback.Stub() {
