...
object Action {
    const val SERVICE = "com.localzet.shadowsocks.SERVICE"
    const val CLOSE = "com.localzet.shadowsocks.CLOSE"
    const val RELOAD = "com.localzet.shadowsocks.RELOAD"
    const val ABORT = "com.localzet.shadowsocks.ABORT"

    const val EXTRA_PROFILE_ID = "com.localzet.shadowsocks.EXTRA_PROFILE_ID"
}
