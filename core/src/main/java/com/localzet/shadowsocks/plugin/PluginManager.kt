...
import com.localzet.shadowsocks.utils.listenForPackageChanges
...
object PluginManager {
    class PluginNotFoundException(private val plugin: String) : FileNotFoundException(plugin),
        ...
        override fun getLocalizedMessage() = app.getString(com.localzet.shadowsocks.core.R.string.plugin_unknown, plugin)
    }
